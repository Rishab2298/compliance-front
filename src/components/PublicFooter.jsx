    ...
    <footer
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 mb-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul
              ...
              <li>
                <a
                  href="/policies/ai-fair-use-policy"
                  className={
                    theme === "dark"
                      ? "hover:text-blue-400"
                      : "hover:text-blue-600"
              ...
              <li>
                <a
                  href="/policies/gdpr-data-processing-addendum"
                  className={
                    theme === "dark"
                      ? "hover:text-blue-400"
                      : "hover:text-blue-600"
              ...
              <li>
                <a
                  href="/policies/complaints-policy"
                  className={
                    theme === "dark"
                      ? "hover:text-blue-400"
                      : "hover:text-blue-600"
        ...
        <div
          ...
          {/* Footer Links */}
          <div
            className={`flex flex-wrap items-center justify-center gap-4 mb-4 text-sm ${
              theme === "dark" ? "text-slate-400" : "text-slate-600"
            }`}>
            <a
              href="/policies/terms-of-service"
