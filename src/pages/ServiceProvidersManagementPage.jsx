...
const ServiceProvidersManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      desc: "Track CompTIA, Microsoft, Cisco, AWS, and other professional IT certifications and their renewal dates",
      category: "Certifications",
      stats: { active: 342, expiring: 28, expired: 0 },
      compliance: 96
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "Cybersecurity Certifications",
      desc: "Monitor Security+, CISSP, CEH, and other security certifications required for client engagements",
      category: "Certifications",
    ...
    },
    {
      ...
      desc: "Maintain criminal background screenings and security clearances for technicians accessing client sites",
      category: "Compliance",
      stats: { active: 287, expiring: 18, expired: 0 },
      compliance: 97
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "NDA & Confidentiality Agreements",
      desc: "Track non-disclosure agreements and confidentiality commitments for client data protection",
      category: "Legal",
      stats: { active: 298, expiring: 24, expired: 0 },
      compliance: 95
    },
    {
      icon: <MonitorCheck className="w-5 h-5" />,
      title: "Compliance Training Certifications",
      desc: "Monitor HIPAA, PCI-DSS, SOC 2, and industry-specific compliance training for technicians",
      category: "Training",
      stats: { active: 264, expiring: 22, expired: 0 },
      compliance: 93
    },
    {
      icon: <Server className="w-5 h-5" />,
      title: "Vendor Certifications",
      desc: "Track vendor-specific certifications like VMware, Dell, HP, and other technology partner credentials",
      category: "Certifications",
      stats: { active: 198, expiring: 16, expired: 0 },
      compliance: 95
    },
    {
      icon: <Code className="w-5 h-5" />,
      title: "Software Licenses & Credentials",
      desc: "Manage individual software licenses and technician credentials for tools and platforms",
      category: "Licensing",
      stats: { active: 412, expiring: 34, expired: 0 },
      compliance: 96
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Professional Liability Insurance",
      desc: "Track E&O insurance policies, cyber liability coverage, and professional indemnity for service delivery",
      category: "Insurance",
      stats: { active: 178, expiring: 14, expired: 0 },
      compliance: 97
    },
    {
      icon: <Activity className="w-5 h-5" />,
      title: "SOC 2 & ISO Certifications",
      desc: "Monitor SOC 2 Type II, ISO 27001, and other compliance framework certifications for audit readiness",
      category: "Compliance",
      stats: { active: 142, expiring: 11, expired: 0 },
      compliance: 94
    }
  ];

  const categories = ['all', 'Certifications', 'Compliance', 'Training', 'Licensing', 'Legal', 'Insurance'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive credentials and documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your certifications and credentials or import from existing systems",
  ...
  const testimonials = [
    {
      quote: "Complyo transformed our credential tracking. We went from spreadsheet chaos to 96% compliance. Client audits are stress-free now.",
      author: "Michael Chen",
      role: "Operations Manager",
      organization: "TechForce Solutions",
      rating: 5
    },
    {
      quote: "Managing professional certifications and compliance documents for 150+ team members was overwhelming. Complyo automated everything and we've had zero compliance issues since implementation.",
      author: "Rachel Martinez",
      role: "Compliance Director",
      organization: "CloudSync Solutions",
      rating: 5
    },
    {
      quote: "The automated reminders for vendor certifications and NDAs have saved us countless hours. We never miss a renewal and our clients trust our compliance record.",
      author: "David Thompson",
      role: "VP of Service Delivery",
      organization: "Managed IT Professionals",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of certifications and credentials can I track?",
      answer: "You can track any certification or credential with an expiration date including professional certifications, vendor credentials, insurance policies, compliance training, NDAs, and more. The system supports unlimited custom document types."
    },
    {
      question: "Is my data secure and audit-ready?",
      answer: "Yes. All data is encrypted with 256-bit encryption and stored on Amazon AWS with bank-grade security. We maintain comprehensive audit trails for all access and changes, ensuring you're always client audit-ready."
    },
    {
    ...
    {
      question: "Can I track team members across multiple client sites?",
      answer: "Absolutely! Complyo is designed for multi-site service provider operations. You can manage different certification requirements, compliance needs, and renewal dates for each client while maintaining centralized company-wide oversight."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like network topology */}
            ...
            <div className="space-y-8 font-plex">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 border rounded-full animate-fade-in-up border-blue-500/30 bg-blue-500/5">
                ...
                <span className={`text-sm font-medium ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`}>
                  Service Provider Compliance Platform
                </span>
              </div>
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Automated tracking for professional certifications, vendor credentials, insurance policies, and compliance training.
                Keep your entire service team certified and client-ready.
              </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold font-mono-custom text-gradient-blue-cyan">95.6%</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'Professional Certifications', value: 96, color: 'blue' },
                      { label: 'Insurance & Legal Docs', value: 94, color: 'cyan' },
                      { label: 'Compliance Training', value: 93, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    <div>
                      ...
                      <p className="text-lg font-bold font-mono-custom text-gradient-blue-cyan">2,277</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Expiring</p>
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">179</p>
                    </div>
                    <div>
              ...
              <div className={`absolute -bottom-6 -left-6 p-4 border rounded-xl backdrop-blur-sm ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>18 days</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col items-center justify-center mb-20">
            ...
            <h2 className="mb-4 text-4xl font-bold text-center md:text-5xl w-fit">
              Track Every
              <br />
              <span className="text-gradient-blue-cyan">Technician Credential</span>
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              Precision-engineered tools for complete service provider compliance
            </p>
          </div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what service providers say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking service providers building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo for your service provider business
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our service provider compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first framework built for growing service provider teams.
              </p>
...
export default ServiceProvidersManagementPage;
