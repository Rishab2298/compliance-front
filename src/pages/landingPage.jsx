    ...
    <div className="w-screen min-h-screen text-white bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="px-6 py-4 mx-auto max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <div className="items-center hidden space-x-8 md:flex">
              ...
              <SignedOut>
                <SignInButton>
                  <button className="px-6 py-2 transition-all rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 hover:shadow-lg hover:shadow-blue-500/50">
                    Get Started
                  </button>
                </SignInButton>
              </SignedOut>
        ...
        {mobileMenuOpen && (
          <div className="border-t md:hidden bg-slate-900/95 backdrop-blur-lg border-slate-800">
            <div className="px-6 py-4 space-y-4">
              ...
              <button className="w-full px-6 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500">
                Get Started
              </button>
            </div>
          </div>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl font-bold leading-tight md:text-7xl">
                Keep Every Driver
                <span className="text-transparent bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 bg-clip-text">
                  {" "}
                  Compliant
                </span>{" "}
                Effortlessly
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <button className="flex items-center justify-center px-8 py-4 text-lg font-semibold transition-all rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 hover:shadow-2xl hover:shadow-blue-500/50 group">
                  Start Free Trial
            ...
            <div className="relative">
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-600/20 to-cyan-500/20 blur-3xl"></div>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {benefits.map((benefit, i) => (
              <div key={i} className="text-center">
                <div className="inline-block p-3 mb-3 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {features.map((feature, i) => (
              <div
                key={i}
                className="p-8 transition-all border bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border-slate-700 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 group">
                <div className="inline-block p-3 mb-4 transition-transform rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 group-hover:scale-110">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            {howItWorks.map((step, i) => (
              <div key={i} className="relative">
                ...
                <div className="p-6 transition-all border bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border-slate-700 hover:border-blue-500/50">
                  <div className="flex items-center justify-center w-12 h-12 mb-4 text-2xl font-bold rounded-full bg-gradient-to-br from-blue-600 to-cyan-500">
                    {step.step}
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {pricing.map((plan, i) => (
              <div
                ...
                {plan.popular && (
                  <div className="absolute px-4 py-1 text-sm font-semibold -translate-x-1/2 rounded-full -top-4 left-1/2 bg-gradient-to-r from-blue-600 to-cyan-500">
                    Most Popular
                  </div>
                )}
      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <div className="relative p-12 overflow-hidden text-center bg-gradient-to-r from-blue-600 to-cyan-500 rounded-3xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row">
                <button className="flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 transition-all bg-white rounded-lg hover:bg-blue-50 group">
      ...
      <footer className="px-6 py-12 border-t border-slate-800">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 mb-8 md:grid-cols-4">
            <div>
              <div className="flex items-center mb-4 space-x-3">
                ...
                <span className="font-bold">Logilink</span>
              </div>
          ...
          <div className="pt-8 text-sm text-center border-t border-slate-800 text-slate-400">
            <p>© 2025 Logilink Solutions. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
