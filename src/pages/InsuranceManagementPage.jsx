...
const InsuranceManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      desc: "Track state-specific agent and broker licenses including life, health, property, and casualty credentials",
      category: "Licensing",
      stats: { active: 145, expiring: 11, expired: 0 },
      compliance: 95
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "E&O Insurance",
      desc: "Monitor Errors & Omissions insurance policy expirations for all licensed agents and brokers",
      category: "Insurance",
      stats: { active: 145, expiring: 8, expired: 0 },
      compliance: 97
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Continuing Education Credits",
      desc: "Track CE requirements and course completions for license renewals across all states",
      category: "Training",
      stats: { active: 145, expiring: 18, expired: 0 },
      compliance: 92
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Background Checks",
      desc: "Monitor criminal background screenings and fingerprint clearances required for insurance professionals",
      category: "Compliance",
      stats: { active: 178, expiring: 13, expired: 0 },
      compliance: 94
    },
    {
      icon: <DollarSign className="w-5 h-5" />,
      title: "FINRA Licenses",
      desc: "Track Series 6, 7, 63, 65 and other securities licenses for agents selling investment products",
      category: "Licensing",
      stats: { active: 56, expiring: 4, expired: 0 },
      compliance: 98
    },
    {
      icon: <Scale className="w-5 h-5" />,
      title: "Adjuster Licenses",
      desc: "Monitor claims adjuster licenses and certifications across multiple states and jurisdictions",
      category: "Licensing",
      stats: { active: 67, expiring: 5, expired: 0 },
      compliance: 96
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "Notary Public Certifications",
      desc: "Track notary public commissions for agents and staff handling policy document signings",
    ...
    },
    {
      ...
      desc: "Monitor AML and fraud prevention training compliance required for all insurance professionals",
      category: "Training",
      stats: { active: 178, expiring: 22, expired: 0 },
      compliance: 91
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "State Carrier Appointments",
      desc: "Track carrier appointments and contracting status for agents across all represented insurance companies",
      category: "Appointments",
      stats: { active: 428, expiring: 35, expired: 0 },
      compliance: 93
    },
  ];

  const categories = ['all', 'Licensing', 'Insurance', 'Training', 'Compliance', 'Certifications', 'Appointments'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive insurance documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your insurance documents or import from existing systems",
  ...
  const testimonials = [
    {
      quote: "Complyo has transformed our agency's compliance tracking. We manage 145 agents across 12 states and never miss a license renewal or CE deadline anymore.",
      author: "Michael Anderson",
      role: "Compliance Director",
      organization: "Premier Insurance Group",
      rating: 5
    },
    {
      quote: "Managing E&O policies and carrier appointments was a nightmare. Complyo automated everything and our compliance rate went from 87% to 97% in just 3 months.",
      author: "Jennifer Martinez",
      role: "Agency Owner",
      organization: "Martinez & Associates Insurance",
      rating: 5
    },
    {
      quote: "The automated reminders for FINRA licenses and state appointments have been a game-changer. Our agents appreciate the proactive notifications and we're audit-ready 24/7.",
      author: "David Chen",
      role: "Operations Manager",
      organization: "National Benefits Advisors",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of insurance documents can I track?",
      answer: "You can track any document with an expiration date including agent licenses, E&O policies, CE credits, FINRA licenses, adjuster credentials, state appointments, and more. The system supports unlimited custom document types."
    },
    {
      question: "Can I track agents across multiple states?",
      answer: "Absolutely! Complyo is designed for multi-state compliance. You can track different license types, CE requirements, and renewal dates for each state your agents are licensed in, plus manage carrier appointments across all jurisdictions."
    },
    {
    ...
    {
      question: "Is my data secure and state audit-ready?",
      answer: "Yes. All data is encrypted with 256-bit encryption and stored on Amazon AWS with bank-grade security. We maintain comprehensive audit trails for all access and changes, ensuring you're always ready for state insurance department audits."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like insurance forms */}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8 font-plex">
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Comprehensive tracking for agent licenses, E&O policies, FINRA credentials, and continuing education.
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold font-mono-custom text-gradient-blue-cyan">94.7%</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'Agent Licenses', value: 95, color: 'blue' },
                      { label: 'E&O Insurance', value: 97, color: 'cyan' },
                      { label: 'Carrier Appointments', value: 93, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    <div>
                      ...
                      <p className="text-lg font-bold font-mono-custom text-gradient-blue-cyan">2,176</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Expiring</p>
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">119</p>
                    </div>
                    <div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what insurance leaders say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking agencies building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo in your insurance agency
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our insurance compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first insurance framework built for growing agencies.
              </p>
