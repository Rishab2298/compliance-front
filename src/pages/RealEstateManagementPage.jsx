...
const RealEstateManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      desc: "Track agent, broker, and salesperson license renewals across all states and jurisdictions",
      category: "Licensing",
      stats: { active: 87, expiring: 6, expired: 0 },
      compliance: 97
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "E&O Insurance",
      desc: "Monitor Errors & Omissions insurance policy expirations for all licensed real estate professionals",
      category: "Insurance",
      stats: { active: 87, expiring: 4, expired: 0 },
      compliance: 98
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Continuing Education",
      desc: "Track required CE credits and certification renewals for license maintenance and compliance",
      category: "Training",
      stats: { active: 87, expiring: 12, expired: 0 },
      compliance: 94
    },
    {
      icon: <Users className="w-5 h-5" />,
      title: "Fair Housing Certifications",
      desc: "Monitor fair housing training and anti-discrimination certification compliance for all staff",
      category: "Training",
      stats: { active: 102, expiring: 8, expired: 0 },
      compliance: 95
    },
    {
      icon: <Building2 className="w-5 h-5" />,
      title: "Property Management Licenses",
      desc: "Track property manager licenses and certifications required for managing rental properties",
      category: "Licensing",
    ...
    },
    {
      ...
      desc: "Monitor background check and criminal record screening expirations for all real estate personnel",
      category: "Personal",
      stats: { active: 102, expiring: 7, expired: 0 },
      compliance: 96
    },
    {
      icon: <Award className="w-5 h-5" />,
      title: "Notary Public Certifications",
      desc: "Track notary public commission renewals for agents and staff handling document signings",
    ...
    },
    {
      ...
      desc: "Monitor professional liability and general liability insurance policy renewals for all agents",
      category: "Insurance",
      stats: { active: 87, expiring: 5, expired: 0 },
      compliance: 97
    },
    {
      icon: <Database className="w-5 h-5" />,
      title: "MLS Memberships",
      desc: "Track Multiple Listing Service membership renewals and dues payments for active agents",
      category: "Memberships",
      stats: { active: 87, expiring: 0, expired: 0 },
      compliance: 100
    },
    {
      icon: <Home className="w-5 h-5" />,
      title: "Lead-Based Paint Certifications",
      desc: "Monitor EPA lead-based paint training certifications required for pre-1978 properties",
      category: "Certifications",
      stats: { active: 87, expiring: 9, expired: 0 },
      compliance: 93
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Contractor Licenses",
      desc: "Track contractor and vendor licenses for property management and maintenance staff",
      category: "Licensing",
    ...
    },
    {
      ...
      desc: "Monitor driver's license renewals for agents showing properties and property managers",
      category: "Personal",
      stats: { active: 102, expiring: 6, expired: 0 },
      compliance: 95
    },
    {
      icon: <Award className="w-5 h-5" />,
      title: "Professional Designations",
      desc: "Track NAR designations (CRS, GRI, ABR) and professional certification renewals",
      category: "Certifications",
    ...
    },
    {
      ...
      desc: "Monitor GDPR, CCPA, and data privacy training compliance for handling client information",
      category: "Training",
      stats: { active: 102, expiring: 11, expired: 0 },
      compliance: 92
    },
  ];

  const categories = ['all', 'Licensing', 'Insurance', 'Training', 'Certifications', 'Personal', 'Memberships'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive real estate documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your real estate documents or import from existing systems",
  ...
  const testimonials = [
    {
      quote: "Complyo has transformed how we manage agent compliance. We never miss a license renewal and our E&O insurance is always current. It's been a game-changer.",
    ...
    {
      quote: "Managing continuing education for 50+ agents was a nightmare. Complyo automated everything and we're now 100% compliant across all states we operate in.",
      author: "Robert Garcia",
      role: "Compliance Director",
      organization: "Metro Property Solutions",
      rating: 5
    },
    {
      quote: "The automated reminders for fair housing training and lead paint certifications have saved us countless hours. Our audit process is now seamless.",
      author: "Amanda Chen",
      role: "Property Management Director",
      organization: "Citywide Management Co.",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of real estate documents can I track?",
      answer: "You can track any document with an expiration date including real estate licenses, E&O insurance, continuing education certificates, fair housing certifications, MLS memberships, and more. The system supports unlimited custom document types."
    },
    {
      question: "Can I track agents across multiple states?",
      answer: "Absolutely! Complyo is designed to manage multi-state compliance. You can track different license types, CE requirements, and renewal dates for each state your agents are licensed in."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. All data is encrypted with 256-bit encryption and stored on Amazon AWS with bank-grade security. We maintain comprehensive audit trails for all access and changes, ensuring you're always audit-ready for state regulatory reviews."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like property blueprints */}
            ...
            <div className="space-y-8 font-plex">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 border rounded-full animate-fade-in-up border-blue-500/30 bg-blue-500/5">
                ...
                <span className={`text-sm font-medium ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`}>
                  Real Estate Compliance Platform
                </span>
              </div>
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Comprehensive tracking for real estate licenses, E&O insurance, continuing education, and property management certifications.
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold font-mono-custom text-gradient-blue-cyan">96.4%</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'Agent Licenses', value: 97, color: 'blue' },
                      { label: 'E&O Insurance', value: 98, color: 'cyan' },
                      { label: 'Continuing Education', value: 94, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    <div>
                      ...
                      <p className="text-lg font-bold font-mono-custom text-gradient-blue-cyan">1,428</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Expiring</p>
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">77</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Alerts</p>
                      <p className="text-lg font-bold text-red-400 font-mono-custom">4</p>
                    </div>
                  </div>
                </div>
              ...
              <div className={`absolute -bottom-20 left-0 p-4 border rounded-xl backdrop-blur-sm ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>3 days</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what real estate professionals say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking brokerages building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo in your real estate brokerage
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our real estate compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first brokerage framework built for growing teams.
              </p>
