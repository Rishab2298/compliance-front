...
const ManufacturingManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      desc: "Track OSHA 10/30 hour training, lockout/tagout, confined space, and PPE certifications for all floor workers",
      category: "Safety",
      stats: { active: 234, expiring: 18, expired: 0 },
      compliance: 95
    },
    {
      icon: <Settings className="w-5 h-5" />,
      title: "Forklift Operator Licenses",
      desc: "Monitor OSHA-compliant forklift operator training and certification renewals for warehouse and production staff",
      category: "Equipment",
    ...
    },
    {
      ...
      title: "Welding Certifications",
      desc: "Track AWS, ASME, and API welding certifications including SMAW, GMAW, GTAW, and FCAW qualifications",
      category: "Technical",
      stats: { active: 45, expiring: 4, expired: 0 },
      compliance: 97
    },
    {
      icon: <Award className="w-5 h-5" />,
      title: "CNC Machinist Certifications",
      desc: "Monitor CNC programming, CAD/CAM, and precision machining certifications for machine operators",
      category: "Technical",
      stats: { active: 38, expiring: 3, expired: 0 },
      compliance: 96
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "Crane & Rigging Licenses",
      desc: "Track mobile crane, overhead crane, and rigging operator certifications and NCCCO credentials",
      category: "Equipment",
      stats: { active: 23, expiring: 2, expired: 0 },
      compliance: 100
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Quality Control Certifications",
      desc: "Monitor ISO 9001 auditor, Six Sigma, ASQ CQI, and quality inspector certifications",
      category: "Quality",
      stats: { active: 34, expiring: 3, expired: 0 },
      compliance: 98
    },
    {
      icon: <Activity className="w-5 h-5" />,
      title: "First Aid & CPR",
      desc: "Track first aid, CPR, and AED certifications required for safety personnel and floor supervisors",
      category: "Safety",
      stats: { active: 56, expiring: 8, expired: 0 },
      compliance: 93
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Hazmat Training",
      desc: "Monitor hazardous materials handling, chemical safety, and RCRA training compliance for all staff",
      category: "Safety",
      stats: { active: 234, expiring: 22, expired: 0 },
      compliance: 92
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "Maintenance Technician Licenses",
      desc: "Track industrial electrician, HVAC, pneumatics, and hydraulics certifications for maintenance staff",
      category: "Technical",
    ...
    },
    {
      ...
      desc: "Monitor background check and criminal record screening expirations for all manufacturing personnel",
      category: "Personal",
      stats: { active: 234, expiring: 15, expired: 0 },
      compliance: 96
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Drug & Alcohol Testing",
      desc: "Track DOT and company-mandated drug and alcohol testing compliance including random testing schedules",
      category: "Compliance",
      stats: { active: 234, expiring: 28, expired: 0 },
      compliance: 90
    },
    {
      icon: <Award className="w-5 h-5" />,
      title: "Pressure Vessel Certifications",
      desc: "Monitor boiler operator, pressure vessel inspector, and ASME certifications for specialized equipment",
      category: "Technical",
    ...
    },
    {
      ...
      desc: "Track fire extinguisher training, evacuation procedures, and emergency response certifications",
      category: "Safety",
      stats: { active: 234, expiring: 19, expired: 0 },
      compliance: 94
    },
    {
      icon: <Users className="w-5 h-5" />,
      title: "Lean Manufacturing Certs",
      desc: "Monitor Lean, Kaizen, 5S, and continuous improvement certifications for production staff",
      category: "Quality",
      stats: { active: 67, expiring: 6, expired: 0 },
      compliance: 95
    },
    {
      icon: <Wrench className="w-5 h-5" />,
      title: "Driving Licenses",
      desc: "Track commercial and standard driver's license renewals for material handlers and logistics staff",
      category: "Personal",
      stats: { active: 145, expiring: 9, expired: 0 },
      compliance: 97
    },
  ];

  const categories = ['all', 'Safety', 'Equipment', 'Technical', 'Quality', 'Compliance', 'Personal'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive manufacturing documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your manufacturing documents or import from existing systems",
  ...
  const testimonials = [
    {
      quote: "Complyo transformed our safety compliance tracking. We went from spreadsheet chaos to 95% compliance. OSHA audits are now a breeze.",
    ...
    {
      quote: "Managing forklift certifications and welding qualifications for 200+ employees was overwhelming. Complyo automated everything and we've had zero compliance violations since.",
      author: "Lisa Chen",
      role: "Safety Director",
      organization: "Advanced Fabrication Co.",
      rating: 5
    },
    {
      quote: "The automated reminders for crane operator licenses and maintenance tech certifications have saved us countless hours. Production never stops due to expired credentials anymore.",
      author: "Robert Williams",
      role: "Operations Manager",
      organization: "Industrial Systems Group",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of manufacturing documents can I track?",
      answer: "You can track any document with an expiration date including OSHA certifications, forklift licenses, welding certs, CNC machinist qualifications, quality control certifications, safety training, and more. The system supports unlimited custom document types."
    },
    {
      question: "Is my data secure and OSHA audit-ready?",
      answer: "Yes. All data is encrypted with 256-bit encryption and stored on Amazon AWS with bank-grade security. We maintain comprehensive audit trails for all access and changes, ensuring you're always OSHA and ISO audit-ready."
    },
    {
    ...
    {
      question: "Can I track different certification types across multiple facilities?",
      answer: "Absolutely! Complyo is designed for multi-facility operations. You can manage different document types, compliance requirements, and renewal dates for each location while maintaining centralized oversight."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like factory floor plans */}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8 font-plex">
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Comprehensive tracking for OSHA certifications, equipment operator licenses, welding qualifications, and quality control credentials.
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold font-mono-custom text-gradient-blue-cyan">94.8%</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'OSHA Certifications', value: 95, color: 'blue' },
                      { label: 'Equipment Licenses', value: 94, color: 'cyan' },
                      { label: 'Welding Qualifications', value: 97, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    <div>
                      ...
                      <p className="text-lg font-bold font-mono-custom text-gradient-blue-cyan">3,510</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Expiring</p>
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">155</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Alerts</p>
                      <p className="text-lg font-bold text-red-400 font-mono-custom">12</p>
                    </div>
                  </div>
                </div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what manufacturing leaders say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking manufacturers building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo in your manufacturing facility
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our manufacturing compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first production framework built for growing teams.
              </p>
