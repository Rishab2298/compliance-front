...
const SecurityGuardManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      title: "Security Guard Licenses",
      desc: "Track state-specific security officer licenses and registrations including armed and unarmed certifications",
      category: "Licensing",
    ...
    },
    {
      ...
      desc: "Maintain criminal background checks, fingerprinting clearances, and ongoing screening requirements",
      category: "Compliance",
      stats: { active: 298, expiring: 12, expired: 0 },
      compliance: 98
    },
    {
      icon: <Activity className="w-5 h-5" />,
      title: "CPR & First Aid",
      desc: "Monitor CPR, AED, and First Aid certifications to ensure emergency preparedness",
      category: "Safety",
      stats: { active: 265, expiring: 22, expired: 0 },
      compliance: 94
    },
    {
      icon: <ShieldCheck className="w-5 h-5" />,
      title: "Firearms Permits",
      desc: "Track firearms qualifications, concealed carry permits, and weapons training for armed security personnel",
      category: "Certifications",
      stats: { active: 142, expiring: 9, expired: 0 },
      compliance: 96
    },
    {
      icon: <Target className="w-5 h-5" />,
      title: "Defensive Tactics Training",
      desc: "Monitor baton, OC spray, handcuffing, and defensive tactics certifications",
      category: "Training",
      stats: { active: 231, expiring: 15, expired: 0 },
      compliance: 95
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "Security Training Certifications",
      desc: "Track initial guard training, continuing education, and specialized security certifications",
      category: "Training",
      stats: { active: 289, expiring: 19, expired: 0 },
      compliance: 96
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Driving Licenses",
      desc: "Manage driver's licenses and defensive driving certifications for patrol and mobile security officers",
      category: "Personal",
      stats: { active: 178, expiring: 11, expired: 0 },
      compliance: 97
    },
    {
      icon: <AlertTriangle className="w-5 h-5" />,
      title: "Drug & Alcohol Testing",
      desc: "Monitor pre-employment, random, and post-incident drug and alcohol screenings",
      category: "Compliance",
      stats: { active: 302, expiring: 8, expired: 0 },
      compliance: 99
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "SORA Registrations",
      desc: "Track Security Officer Registration Act compliance and state-specific registration requirements",
      category: "Licensing",
      stats: { active: 294, expiring: 14, expired: 0 },
      compliance: 97
    }
  ];

  const categories = ['all', 'Licensing', 'Training', 'Certifications', 'Safety', 'Compliance', 'Personal'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive security documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your security documents or import from existing systems",
  ...
  const testimonials = [
    {
      quote: "Complyo transformed our credential tracking. We went from spreadsheet chaos to 97% compliance. State audits are stress-free now.",
    ...
    {
      quote: "Managing security licenses and firearms permits for 200+ guards was overwhelming. Complyo automated everything and we've had zero compliance issues since implementation.",
      author: "Sarah Martinez",
      role: "Compliance Director",
      organization: "Guardian Protection Group",
      rating: 5
    },
    {
      quote: "The automated reminders for firearms qualifications and background checks have saved us countless hours. We never miss a renewal and our clients trust our compliance record.",
      author: "David Chen",
      role: "VP of Operations",
      organization: "Elite Security Solutions",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of security documents can I track?",
      answer: "You can track any document with an expiration date including security licenses, firearms permits, background checks, CPR certifications, defensive tactics training, SORA registrations, and more. The system supports unlimited custom document types."
    },
    {
      question: "Is my data secure and audit-ready?",
      answer: "Yes. All data is encrypted with 256-bit encryption and stored on Amazon AWS with bank-grade security. We maintain comprehensive audit trails for all access and changes, ensuring you're always state audit-ready."
    },
    {
    ...
    {
      question: "Can I track guards across multiple sites or states?",
      answer: "Absolutely! Complyo is designed for multi-site operations. You can manage different document types, compliance requirements, and renewal dates for each location while maintaining centralized company-wide oversight."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like security grids */}
            ...
            <div className="space-y-8 font-plex">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 border rounded-full animate-fade-in-up border-blue-500/30 bg-blue-500/5">
                ...
                <span className={`text-sm font-medium ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`}>
                  Security Guard Compliance Platform
                </span>
              </div>
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Automated tracking for guard licenses, firearms permits, SORA registrations, defensive tactics certifications, and background checks.
                Keep your entire security team compliant across all locations.
              </p>
              ...
              <div className={`relative p-8 border rounded-2xl backdrop-blur-sm ${
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'Security Licenses', value: 97, color: 'blue' },
                      { label: 'Firearms Permits', value: 96, color: 'cyan' },
                      { label: 'Safety Certifications', value: 94, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">128</p>
                    </div>
                    <div>
              ...
              <div className={`absolute -bottom-20 left-0 p-4 border rounded-xl backdrop-blur-sm ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>21 days</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what security leaders say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking security companies building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo in your security company
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our security compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first security framework built for growing companies.
              </p>
