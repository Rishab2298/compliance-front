...
const EducationManagementPage = () => {
  ...
  const employeeDocuments = [
    {
      ...
      desc: "Track state teaching certifications, credentials, and license renewals for all certified educators",
      category: "Licensing",
      stats: { active: 124, expiring: 8, expired: 0 },
      compliance: 97
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Background Checks",
      desc: "Monitor criminal background screenings, FBI clearances, and background check renewals for all staff",
      category: "Security",
    ...
    },
    {
      ...
      title: "CPR & First Aid",
      desc: "Track CPR, first aid, and AED certifications required for teachers and support staff",
      category: "Safety",
      stats: { active: 89, expiring: 9, expired: 0 },
      compliance: 93
    },
    {
      icon: <FileCheck className="w-5 h-5" />,
      title: "TB Tests & Health Screenings",
      desc: "Monitor tuberculosis tests, health screenings, and immunization records for all employees",
      category: "Health",
    ...
    },
    {
      ...
      desc: "Track professional development hours, CE credits, and recertification requirements",
      category: "Training",
      stats: { active: 124, expiring: 15, expired: 0 },
      compliance: 92
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "Fingerprinting Clearances",
      desc: "Monitor Live Scan fingerprinting and DOJ clearance expirations for security compliance",
      category: "Security",
      stats: { active: 156, expiring: 10, expired: 0 },
      compliance: 96
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "Child Safety Training",
      desc: "Track mandated reporter training, child abuse prevention, and safety compliance certifications",
      category: "Safety",
      stats: { active: 156, expiring: 14, expired: 0 },
      compliance: 94
    },
    {
      icon: <Award className="w-5 h-5" />,
      title: "Special Education Certifications",
      desc: "Monitor SPED credentials, IEP training, and special needs education certifications",
      category: "Licensing",
  ...
  const categories = ['all', 'Licensing', 'Security', 'Safety', 'Health', 'Training'];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Bank-grade encryption on Amazon AWS ensures your sensitive education documents are protected",
  ...
  const howItWorksSteps = [
    {
      ...
      desc: "Drag and drop your education documents or import from existing systems",
  ...
  const testimonials = [
    {
      ...
      role: "HR Director",
      organization: "Sunrise School District",
      rating: 5
    },
    {
      quote: "Managing teaching licenses and background checks for 150+ staff was overwhelming. Complyo automated everything and we've had zero compliance issues since implementation.",
      author: "James Wilson",
      role: "Compliance Officer",
      organization: "Excellence Academy Network",
      rating: 5
    },
    {
      quote: "The automated reminders for CPR certifications and TB tests have saved us countless hours. We never miss a renewal and our staff appreciate the proactive notifications.",
      author: "Dr. Maria Rodriguez",
      role: "Principal",
      organization: "Lakeside Elementary School",
      rating: 5
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "What types of education documents can I track?",
      answer: "You can track any document with an expiration date including teaching licenses, background checks, CPR certifications, TB tests, continuing education credits, fingerprinting clearances, and more. The system supports unlimited custom document types."
    },
    {
    ...
    {
      question: "Can I track staff across multiple schools or campuses?",
      answer: "Absolutely! Complyo is designed for multi-campus operations. You can manage different document types, compliance requirements, and renewal dates for each location while maintaining centralized district-wide oversight."
    },
    {
  ...
  return (
    <PublicLayout>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Precision grid - like lesson plans */}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8 font-plex">
              ...
              <p className={`text-xl leading-relaxed max-w-xl animate-fade-in-up stagger-2 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                Comprehensive tracking for teaching licenses, background checks, CPR certifications, and continuing education credits.
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold font-mono-custom text-gradient-blue-cyan">95.3%</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {[
                      { label: 'Teaching Licenses', value: 97, color: 'blue' },
                      { label: 'Background Checks', value: 95, color: 'cyan' },
                      { label: 'Safety Certifications', value: 93, color: 'blue' },
                    ].map((item, i) => (
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                    <div>
                      ...
                      <p className="text-lg font-bold font-mono-custom text-gradient-blue-cyan">1,337</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Expiring</p>
                      <p className="text-lg font-bold text-yellow-400 font-mono-custom">89</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-400">Alerts</p>
                      <p className="text-lg font-bold text-red-400 font-mono-custom">6</p>
                    </div>
                  </div>
                </div>
      ...
      <section className={`px-6 py-24 ${theme === 'dark' ? 'bg-slate-900/30' : 'bg-slate-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center font-plex">
            ...
            <p className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
              See what education leaders say about Complyo
            </p>
          </div>
      ...
      <section className={`px-6 py-20 border-y ${theme === 'dark' ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-4xl mx-auto text-center font-plex">
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
            Join forward-thinking schools and districts building compliance-first operations
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                ...
                <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                  Everything you need to know about implementing Complyo in your school or district
                </p>
                ...
                <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                      Our education compliance experts are here to help you get started
                    </p>
                  </div>
          ...
          <div className="relative p-12 overflow-hidden text-center border rounded-3xl md:p-16 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 border-blue-500/30">
            ...
            <div className="relative z-10 font-plex">
              ...
              <p className="mb-4 text-xl text-blue-50">
                Start with a compliance-first education framework built for growing schools.
              </p>
