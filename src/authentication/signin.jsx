  ...
  return (
    <div className="grid min-h-screen w-screen lg:grid-cols-2 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10 relative">
        ...
        <div className="absolute top-1/4 left-0 w-96 h-96 bg-gradient-to-r from-blue-500/10 via-violet-500/10 to-purple-500/10 rounded-full blur-3xl -z-10"></div>

        {/* Logo */}
        <div className="flex justify-center gap-3 md:justify-start">
          <a href="/" className="flex items-center gap-3 group">
            <div className="bg-gradient-to-br from-blue-600 via-violet-600 to-purple-600 p-2 rounded-lg group-hover:shadow-lg group-hover:shadow-purple-500/50 transition-all">
              <Shield className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl font-bold bg-gradient-to-r from-blue-400 via-violet-400 to-purple-400 bg-clip-text text-transparent">
              Compliance Manager
            </span>
          </a>
        </div>
      ...
      <div className="relative hidden lg:block bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-l border-slate-800">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg space-y-6 text-center">
            <div className="inline-block bg-violet-500/10 text-violet-400 px-4 py-2 rounded-full text-sm border border-violet-500/20 mb-4">
              Trusted by Leading DSPs
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
              Automated Compliance,
              <span className="block bg-gradient-to-r from-blue-400 via-violet-400 to-purple-400 bg-clip-text text-transparent mt-2">
                Simplified
              </span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 via-violet-400 to-purple-400 bg-clip-text text-transparent mb-1">
                  99%
                </div>
