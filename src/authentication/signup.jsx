  ...
  return (
    <div className="grid w-screen min-h-screen lg:grid-cols-2 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative flex flex-col gap-4 p-6 md:p-10">
        ...
        <div className="absolute left-0 rounded-full top-1/4 w-96 h-96 bg-blue-500/10 blur-3xl -z-10"></div>
        
        {/* Logo */}
        <div className="flex justify-center gap-3 md:justify-start">
          <a href="/" className="flex items-center gap-3 group">
            <div className="p-2 transition-all rounded-lg bg-gradient-to-br from-blue-500 to-cyan-400 group-hover:shadow-lg group-hover:shadow-blue-500/50">
        ...
        <div className="text-sm text-center text-slate-400">
          <p>
           ...
           <SignInButton>
            <button className="font-medium text-blue-400 transition-colors border-0 hover:text-blue-300 bg-none">
              Start free trial
            </button>
            </SignInButton>
          </p>
      ...
      <div className="relative hidden border-l lg:block bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-slate-800">
        ...
        <div className="absolute right-0 rounded-full top-1/3 w-96 h-96 bg-cyan-500/20 blur-3xl"></div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg space-y-6 text-center">
            ...
            <h2 className="text-4xl font-bold leading-tight text-white md:text-5xl">
              ...
              <span className="block mt-2 text-transparent bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text">
                Simplified
              </span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="mb-1 text-3xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text">
                  99%
                </div>
